...
export interface DalysalesChart {
  id: number;
  imagePath: string;
  uname: string;
  position: string;
...
export class AppDashboardComponent {
  ...
  public ViewsChart!: Partial<ViewsChart> | any;
  public DalysalesChart!: Partial<DalysalesChart> | any;
  public TasksChart!: Partial<TasksChart> | any;
